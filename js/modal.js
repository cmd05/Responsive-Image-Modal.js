...
t.appendChild(o),t.appendChild(d);const a=document.getElementsByClassName(e)[0];a.prepend(t),a.addEventListener("click",function(e){const t=e.target,o=e.target.className,d=t.id;"
img-modal-overlay"==o||"close-img-modal"==o||"img-show"==o?closeImgModal():"modal-img"==d&&event.stopPropagation()})}function addModal(e)
